    ...
    registerCollection: function(collection, cb) {
        ...
        instance = {
          config: {
            ...
            modelTypeField: config.modelTypeField,
    ...
    // },
      ...
      update: function(collectionName, options, values, cb) {
        ...
        request.makeRequest(collections[collectionName], 'find', function(err, models) {
          ...
          var newValues = {};
          _.extend(newValues, models[0]);
          _.extend(newValues, values);
          delete newValues._id;
          delete newValues.id;
          _.extend(options.where, {'id': models[0]._id});
          request.makeRequest(collections[collectionName], 'update', cb, options, newValues);
        }, options);
      },
